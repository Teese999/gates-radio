...
# Загрузка прошивки
# ВАЖНО: Используем обычную загрузку БЕЗ стирания flash, чтобы сохранить NVS данные
# NVS содержит ключи, телефоны и WiFi настройки, которые должны сохраняться при перепрошивке
echo "📤 Загрузка прошивки на ESP32 (NVS данные сохранятся)..."
