...
ISOLATION = [
    ...
    ('ACIN.L', 'TP12', '∞ — сеть изолирована от 12 В'),
    ('ACIN.L', 'TPG', '∞ — сеть изолирована от земли'),
    ('ACIN.N', 'TP12', '∞'),
    ('ACIN.N', 'TPG', '∞'),
    ('TP12', 'TPG', 'не КЗ: >1 кОм; короткий писк заряда конденсаторов — норма'),
    ('TP5', 'TPG', 'не КЗ (входы модулей)'),
    ('TP4', 'TPG', 'не КЗ'),
    ('TP33', 'TPG', 'не КЗ'),
    ('TP12', 'TP5', '∞ / не КЗ — шины разделены понижайкой'),
    ('TP12', 'TP4', '∞ / не КЗ'),
    ('TP5', 'TP33', '∞ / не КЗ'),
]
...
на выходах понижаек (щупы на TP5/TP4 против TPG), обесточить, вставить модули.</div>
</html>"""
