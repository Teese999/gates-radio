...
// Предохранитель стоит на плате, отверстия под него в стенке нет — на одну
// дырку меньше, влагозащита лучше.
//
...
gland_in_x  = 52;     // ввод 220 из щитка -> клеммник ACIN
gland_out_x = 88;     // кабель к приводу с клеммника ACOUT
